...
(function() {
    ...
    window.JSON && window.JSON.stringify || function() {
        ...
        function b(e, ba) {
            ...
            case "object":
                ...
                if (q && "object" === typeof q) {
                    ...
                    for (K = 0; K < u; K += 1)
                        g = q[K],
                        "string" === typeof g && (N = b(g, s)) && G.push(c(g) + (f ? ": " : ":") + N)
                } else
                    for (g in s)
                        Object.hasOwnProperty.call(s, g) && (N = b(g, s)) && G.push(c(g) + (f ? ": " : ":") + N);
                N = 0 === G.length ? "{}" : f ? "{\n" + f + G.join(",\n" + f) + "\n" + E + "}" : "{" + G.join(",") + "}";
                f = E;
                return N
            }
        ...
        var e = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, f, w, E = {
            "\b": "\\b",
            "\t": "\\t",
            "\n": "\\n",
            "\f": "\\f",
    ...
    var oa, pa = Math.floor(20 * Math.random());
    oa = function(a, c) {
        return 0 < a.indexOf("pubsub.") && a.replace("pubsub", "ps" + (c ? qa().split("-")[0] : 20 > ++pa ? pa : pa = 1)) || a
    }
    ;
    function ra(a, c) {
        var b = a.join(fa)
    ...
    function sa(a, c) {
        function b() {
            f + c > H() ? (clearTimeout(e),
            e = setTimeout(b, c)) : (f = H(),
            a())
        }
        var e, f = 0;
        return b
    ...
    function va(a, c) {
        return a.replace(ma, function(a, e) {
            return c[e] || a
        })
    }
    function qa(a) {
        ...
        return {
            encrypt: function(f, q, g) {
                ...
                var g = a(g)
                  ...
                  , q = c(q, g)
                  , g = JSON.stringify(f);
                return CryptoJS.AES.encrypt(g, q, {
                    iv: p,
                    mode: w
                }).ciphertext.toString(CryptoJS.enc.Base64) || f
            },
          ...
          , eb = function(a) {
            ...
            if ($a || ab()) {
                a: {
                    ...
                    }, q), ba = a.b || C(), K = a.data || {}, g = a.c || C(), N = !a.h, u = function(a, c) {
                        w || (w = 1,
                        clearTimeout(p),
                        b && (b.onerror = b.onload = y,
                        b.abort && b.abort(),
                        b = y),
                        a && ba(c))
                    };
                    try {
                        b = ab() || window.XDomainRequest && new XDomainRequest || new XMLHttpRequest;
                        b.onerror = b.onabort = function(a) {
                            u(1, a || b && b.responseText || {
          ...
          , zb = function(a) {
            ...
            function E(i, a, b, d) {
                var a = i.callback || a
                  ...
                  , v = M()
                  , d = d || {};
                d.auth || (d.auth = i.auth_key || D);
                i = [O, "v1", "channel-registration", "sub-key", t];
                i.push.apply(i, b);
                v && (d.callback = v);
                L({
                    a: v,
            ...
            function q(i, a) {
                if ("object" == typeof i && i.error) {
                    var b = {};
                    i.message && (b.message = i.message);
                    i.payload && (b.payload = i.payload);
                    a && a(b)
                } else
                    a && a(i)
            }
            function p(i, a, b) {
                if ("object" == typeof i) {
                    if (i.error) {
                        ...
                        i.payload && (a.payload = i.payload);
                        b && b(a);
                        return
                    }
                    if (i.payload) {
                        i.next_page ? a && a(i.payload, i.next_page) : a && a(i.payload);
                        return
                    }
                }
                a && a(i)
            ...
            function u() {
                clearTimeout(Ca);
                !Q || 500 <= Q || 1 > Q || !za(I, r).length && !Aa(S, r).length ? Qa = A : (Qa = r,
            ...
            function G(a, b) {
                return Da.decrypt(a, b || ka) || Da.decrypt(a, ka) || a
            }
            function Ha(a, b, c) {
                var d = A;
            ...
            $a = a.jsonp ? 0 : -1 == mb.indexOf("MSIE 6");
            var V = a.subscribe_key || "";
            a.uuid || nb.get(V + "uuid");
            var Ma = a.leave_on_unload || 0;
            a.xdr = eb;
            a.db = nb;
            a.error = a.error || Oa;
            a._is_online = gb;
            ...
            , ha = a.db || {
                get: C(),
                set: C()
            }, ka = a.cipher_key, J = a.uuid || !a.unique_uuid && ha && ha.get(t + "uuid") || "", Z = a.instance_id || A, U = "", Y, ja;
            2 === T && (Q = 1);
            var Da = a.crypto_obj || {
                encrypt: function(a) {
                    return a
              ...
              , x = {
                ...
                LEAVE_GROUP: function(a, b, c, d, j) {
                    var c = {
                        uuid: J,
                        auth: c || D
                    }
                ...
                channel_group: function(a, b) {
                    var c = a.channel_group, b = b || a.callback, d = a.channels || a.channel, j = a.cloak, v, z, h = [], e = {}, f = a.mode || "add";
                    c && (c = c.split(":"),
                    1 < c.length ? (v = "*" === c[0] ? y : c[0],
                    z = c[1]) : z = c[0]);
                    ...
                    d ? (wa(d) && (d = d.join(",")),
                    e[f] = d,
                    e.cloak = Ra ? "true" : "false") : "remove" === f && h.push("remove");
                    "undefined" != typeof j && (e.cloak = j ? "true" : "false");
                    E(a, b, h, e)
                },
                ...
                channel_group_remove_channel: function(a, b) {
                    if (!a.channel_group)
                        return m("Missing Channel Group");
                    if (!a.channel && !a.channels)
                        return m("Missing Channel");
                    a.mode = "remove";
                    x.channel_group(a, b)
                },
                channel_group_remove_group: function(a, b) {
                    if (!a.channel_group)
                        return m("Missing Channel Group");
                    if (a.channel)
                        return m("Use channel_group_remove_channel if you want to remove a channel from a group.");
                    a.mode = "remove";
                    x.channel_group(a, b)
                },
                ...
                channel_group_cloak: function(a, b) {
                    "undefined" == typeof a.cloak ? b(Ra) : (Ra = a.cloak,
                    x.channel_group(a, b))
                },
                ...
                history: function(a, b) {
                    ...
                    if (!h && !e)
                        return m("Missing Channel");
                    if (!b)
                        return m("Missing Callback");
                    if (!t)
                        return m("Missing Subscribe Key");
                    p.stringtoken = "true";
                    p.count = c;
                    p.reverse = d;
                    p.auth = v;
                    ...
                    L({
                        ...
                        c: function(a) {
                            if ("object" == typeof a && a.error)
                                ...
                                for (var i = a[0], c = [], d = 0; d < i.length; d++) {
                                    var h = G(i[d], z);
                                    try {
                                        c.push(JSON.parse(h))
                                    } catch (v) {
                ...
                replay: function(a, b) {
                    var b = b || a.callback || C()
                      ...
                      , g = {};
                    if (!d)
                        return m("Missing Source Channel");
                    if (!j)
                        return m("Missing Destination Channel");
                    if (!P)
                        return m("Missing Publish Key");
                    if (!t)
                        return m("Missing Subscribe Key");
                    "0" != q && (g.callback = q);
                    v && (g.stop = "all");
                ...
                publish: function(a, b) {
                    ...
                    c = JSON.stringify(Da.encrypt(c, v || ka) || c);
                    c = [O, "publish", P, t, 0, encodeURIComponent(d), f, encodeURIComponent(c)];
                    R = {
                        uuid: J,
                        auth: j
                    };
                ...
                unsubscribe: function(a, b) {
                    var e = a.channel
                      ...
                      , f = a.error || C();
                    ga = 0;
                    e && (e = xa((e.join ? e.join(",") : "" + e).split(","), function(a) {
                        if (I[a])
                            return a + "," + a + ea
                    }).join(","),
                    $(e.split(","), function(a) {
                        ...
                        a && (I[a] = 0,
                        a in X && delete X[a],
                        ca && (c = x.LEAVE(a, 0, j, b, f)),
                        c || b({
                            action: "leave"
                        }))
                    }));
                    d && (d = xa((d.join ? d.join(",") : "" + d).split(","), function(a) {
                        if (S[a])
                            return a + "," + a + ea
                    }).join(","),
                    $(d.split(","), function(a) {
                ...
                subscribe: function(a, b) {
                    ...
                    function d() {
                        ...
                        if (b || i) {
                            ...
                            i && (j["channel-group"] = i);
                            2 < JSON.stringify(X).length && (j.state = JSON.stringify(X));
                            T && (j.heartbeat = T);
                            Z && (j.instanceid = U);
                            N();
                            Ba = L({
                                ...
                                a: a,
                                b: function(a) {
                                    a && a.error && a.service ? (q(a, p),
                                    f(1)) : x.time(function(b) {
                                        !b && q(a, p);
                                        f(b)
                                    })
                                },
                                ...
                                c: function(a) {
                                    ...
                                    if (Ta && !Fa)
                                        ...
                                        var b, i = "", j = "";
                                        3 < a.length ? (i = a[3],
                                        j = a[2]) : i = 2 < a.length ? a[2] : xa(za(I), function(b) {
                                            return xa(Array(a[0].length).join(",").split(","), function() {
                                                return b
                                            })
                                        }).join(",");
                                        var e = i.split(",")
                                        ...
                                        b = function() {
                                            var a = e.shift() || kb
                                              , b = f.shift()
                                              , c = {};
                                            b ? (a && (0 <= a.indexOf("-pnpres") && 0 > b.indexOf("-pnpres")) && (b += "-pnpres"),
                                            c = S[b] || I[b] || {
                                                callback: C()
                                            }) : c = I[a];
                                            a = [c.a || Sa, a.split(ea)[0]];
                                        ...
                                        $(a[0], function(c) {
                                            var i = b()
                                              , c = G(c, I[i[1]] ? I[i[1]].cipher_key : y);
                                            i[0] && i[0](c, a, i[2] || i[1], h, i[1])
                                        })
                                    }
                                    setTimeout(d, R)
                                }
                    ...
                    if (!t)
                        return m("Missing Subscribe Key");
                    (V || 0 === V || W || 0 === W) && x.set_heartbeat(V, W);
                    j && $((j.join ? j.join(",") : "" + j).split(","), function(c) {
                        var d = I[c] || {};
                        I[kb = c] = {
                            name: c,
                            f: d.f,
                ...
                here_now: function(a, b) {
                    ...
                    j && h.push("channel") && h.push(encodeURIComponent(j));
                    "0" != f && (d.callback = f);
                    e && (d["channel-group"] = e,
                    !j && h.push("channel") && h.push(","));
                    Z && (d.instanceid = U);
                    L({
                        a: f,
                        data: B(d),
                ...
                state: function(a, b) {
                    ...
                    if (!t)
                        return m("Missing Subscribe Key");
                    if (!f)
                        return m("Missing UUID");
                    if (!h && !g)
                        return m("Missing Channel");
                    "0" != j && (d.callback = j);
                    "undefined" != typeof h && I[h] && I[h].e && e && (X[h] = e);
                    "undefined" != typeof g && (S[g] && S[g].e) && (e && (X[g] = e),
                    d["channel-group"] = g,
                    h || (h = ","));
                ...
                mobile_gw_provision: function(a) {
                    var b = a.callback || C()
                      ...
                      , a = a.device_id;
                    if (!a)
                        return m("Missing Device ID (device_id)");
                    if (!h)
                        return m("Missing GW Type (gw_type: gcm or apns)");
                    if (!g)
                        return m("Missing GW Operation (op: add or remove)");
                    if (!f)
                        return m("Missing gw destination Channel (channel)");
                    if (!P)
                        return m("Missing Publish Key");
                    if (!t)
                        return m("Missing Subscribe Key");
                    ...
                    "add" == g ? R.add = f : "remove" == g && (R.remove = f);
                    Z && (data.instanceid = U);
                    L({
                        a: e,
                        data: R,
                ...
                presence_heartbeat: function(a) {
                    ...
                    2 < JSON.stringify(X).length && (d.state = JSON.stringify(X));
            ...
            Y = setTimeout(w, F);
            ja = setTimeout(f, bb);
            Ca = setTimeout(N, (Q - 3) * F);
            b();
            var V = x, Ga;
            for (Ga in V)
                V.hasOwnProperty(Ga) && (l[Ga] = V[Ga]);
            l.css = Ya;
            l.$ = Na;
            l.create = Za;
            l.bind = Va;
            ...
            l.secure = l;
            l.crypto_obj = Ja();
            Va("beforeunload", window, function() {
                if (Ma)
            ...
            if (a.notest)
                return l;
            Va("offline", window, l.offline);
            Va("offline", document, l.offline);
            return l
        };
        zb.init = zb;
        zb.secure = zb;
        zb.crypto_obj = Ja();
        "complete" === document.readyState ? setTimeout(Ia, 0) : Va("load", window, function() {
            setTimeout(Ia, 0)
        });
        var Cb = wb || {};
        PUBNUB = zb({
            notest: 1,
            publish_key: Xa(Cb, "pub-key"),
            subscribe_key: Xa(Cb, "sub-key"),
            ssl: !document.location.href.indexOf("https") || "on" == Xa(Cb, "ssl"),
            origin: Xa(Cb, "origin"),
            uuid: Xa(Cb, "uuid")
        });
        window.jQuery && (window.jQuery.PUBNUB = zb);
        "undefined" !== typeof module && (module.exports = PUBNUB) && Ia();
        var hb = Na("pubnubs") || 0;
        if (wb) {
            Ya(wb, {
                position: "absolute",
            ...
            if ("opera"in window || Xa(wb, "flash"))
